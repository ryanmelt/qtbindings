...
Q_DECL_EXPORT TypeHandler Qt_handlers[] = {
    ...
    { "GLbitfield", marshall_it<unsigned int> },
    { "GLbyte", marshall_it<signed char> },
    { "GLshort", marshall_it<short> },
    { "GLint", marshall_it<int> },
    { "GLubyte", marshall_it<unsigned char> },
    { "GLushort", marshall_it<unsigned short> },
    { "GLuint", marshall_it<unsigned int> },
    { "GLsizei", marshall_it<int> },
    { "GLfloat", marshall_it<float> },
    { "GLclampf", marshall_it<float> },
    { "GLdouble", marshall_it<double> },
    { "GLclampd", marshall_it<double> },
#if QT_VERSION >= 0x40200
