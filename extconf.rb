...
File.open('Makefile', 'w') do |file|
  if windows
    ...
    file.puts "\t-mkdir bin\\2.0.0"
    file.puts "\t-mkdir bin\\2.1.0"
    ...
    file.puts "\t-mkdir lib\\2.0.0"
    file.puts "\t-mkdir lib\\2.1.0"
    file.puts ""
    ...
    file.puts "\t-cd bin\\2.0.0 && del /F /Q *"
    file.puts "\t-cd bin\\2.1.0 && del /F /Q *"
    file.puts "\t-cd lib\\1.9 && del /F /Q *"
    file.puts "\t-cd lib\\2.0.0 && del /F /Q *"
    file.puts "\t-cd lib\\2.1.0 && del /F /Q *"
    ...
    file.puts "\t-cd bin/2.0.0 && rm *"
    file.puts "\t-cd bin/2.1.0 && rm *"
    file.puts "\t-cd lib/1.9 && rm *"
    file.puts "\t-cd lib/2.0.0 && rm *"
    file.puts "\t-cd lib/2.1.0 && rm *"
